...
In the summer of 2024, I was leading a recitation on Adversarial Games for [UPenn's AI Class](https://artificial-intelligence-class.org/). It is an exciting module of the course because  students get to apply algorithms decision making in games for the first time. In this module, students learn about the Minimax Algorithm, applying it towards simulating a game of dominoes.
...
It makes sense of course that chess simulators were first developed through an adversarial lens. This is typically how you play chess. But I started to think... this is also the paradigm through which my students and I are learning to write software; learning what AI and computation *is for*. Board games are fun and interesting to explore, but one day my students will apply their knowledge to software that exists within — and influences — the rest of the world.
...
I hope that witnessing this conjures other areas of life that are traditionally adversarial and that we unquestioningly operate withing and perpetuate. And I hope it prompts your imagination on how different our movements in the world might look if we approach them from a different perspective.